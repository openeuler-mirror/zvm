...
#define NS16650_UART0_BASE    DT_REG_ADDR(DT_NODELABEL(uart0))
#define NS16650_UART0_SIZE    DT_REG_SIZE(DT_NODELABEL(uart0))
#define NS16650_UART0_END     (NS16650_UART0_BASE + NS16650_UART0_SIZE)
#define NS16650_UART0_IRQ     DT_NUM_IRQS(DT_NODELABEL(uart0))
#define NS16650_UART0_NAME    DT_NODE_FULL_NAME(DT_NODELABEL(uart0))

#define NS16650_UART1_NAME    DT_NODE_FULL_NAME(DT_NODELABEL(uart1))
#define NS16650_UART1_BASE    DT_REG_ADDR(DT_NODELABEL(uart1))
#define NS16650_UART1_SIZE    DT_REG_SIZE(DT_NODELABEL(uart1))
#define NS16650_UART1_END     (NS16650_UART1_BASE + NS16650_UART1_SIZE)
#define NS16650_UART1_IRQ     DT_NUM_IRQS(DT_NODELABEL(uart1))
#define NS16650_UART1_DEV     DEVICE_DT_GET(DT_INST(1, ns16550))

#define ZVM_VM_UART0_NAME   NS16650_UART1_NAME
#define ZVM_VM_UART0_BASE   NS16650_UART1_BASE
#define ZVM_VM_UART0_SIZE   NS16650_UART1_SIZE
#define ZVM_VM_UART0_END    NS16650_UART1_END
#define ZVM_VM_UART0_IRQ    NS16650_UART1_IRQ
#define ZVM_VM_UART0_DEV    NS16650_UART1_DEV

#define NS16650_UART2_NAME    DT_NODE_FULL_NAME(DT_NODELABEL(uart2))
#define NS16650_UART2_BASE    DT_REG_ADDR(DT_NODELABEL(uart2))
#define NS16650_UART2_SIZE    DT_REG_SIZE(DT_NODELABEL(uart2))
#define NS16650_UART2_END     (NS16650_UART2_BASE + NS16650_UART2_SIZE)
#define NS16650_UART2_IRQ     DT_NUM_IRQS(DT_NODELABEL(uart2))
#define NS16650_UART2_DEV     DEVICE_DT_GET(DT_NODELABEL(uart2))

#define ZVM_VM_UART1_NAME   NS16650_UART2_NAME
#define ZVM_VM_UART1_BASE   NS16650_UART2_BASE
#define ZVM_VM_UART1_SIZE   NS16650_UART2_SIZE
#define ZVM_VM_UART1_END    NS16650_UART2_END
#define ZVM_VM_UART1_IRQ    NS16650_UART2_IRQ
#define ZVM_VM_UART1_DEV    NS16650_UART2_DEV

#define DEFAULT_VM_UART_BASE    NS16650_UART0_BASE
#define DEFAULT_VM_UART_SIZE    NS16650_UART0_SIZE
#define DEFAULT_VM_UART_IRQ     NS16650_UART0_IRQ
#endif /* CONFIG_SOC_RK3568 */
